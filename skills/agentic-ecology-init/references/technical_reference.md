...
the `agentic_ecology` repository into the target workspace root. This equips the
project with the complete dependency configuration and pinned lockfile:

```bash
# Overwrite pyproject.toml and copy uv.lock
